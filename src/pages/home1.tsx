...
const featuredProducts = [
  {
    id: 1,
    name: "home1.products.premiumHeadphones",
    price: "$299.99",
  ...
  {
    id: 2,
    name: "home1.products.fitnessWatch",
    price: "$199.99",
  ...
  {
    id: 3,
    name: "home1.products.ultraHdCamera",
    price: "$599.99",
  ...
  {
    id: 4,
    name: "home1.products.portableSpeaker",
    price: "$89.99",
...
const additionalProducts = [
  {
    id: 5,
    name: "home1.products.gamingLaptop",
    price: "$1,299.99",
  ...
  {
    id: 6,
    name: "home1.products.wirelessEarbuds",
    price: "$149.99",
  ...
  {
    id: 7,
    name: "home1.products.smartphone",
    price: "$899.99",
...
const testimonials = [
  {
    name: "home1.testimonials.sarahJohnson",
    role: "home1.testimonials.verifiedBuyer",
    content: "home1.testimonials.content1",
    avatar: "/images/image1.jpg",
    rating: 5,
    purchase: "home1.products.premiumHeadphones",
    date: "home1.testimonials.weeksAgo"
  },
  {
    name: "home1.testimonials.michaelChen",
    role: "home1.testimonials.premiumMember",
    content: "home1.testimonials.content2",
    avatar: "/images/image2.jpg",
    rating: 5,
    purchase: "home1.products.fitnessWatch",
    date: "home1.testimonials.monthAgo"
  },
  {
    name: "home1.testimonials.emilyRodriguez",
    role: "home1.testimonials.loyalCustomer",
    content: "home1.testimonials.content3",
    avatar: "/images/image3.jpg",
    rating: 5,
    purchase: "home1.products.ultraHdCamera",
    date: "home1.testimonials.weeksAgo"
  },
  {
    name: "home1.testimonials.davidKim",
    role: "home1.testimonials.verifiedBuyer",
    content: "home1.testimonials.content4",
    avatar: "/images/image4.jpg",
    rating: 5,
    purchase: "home1.products.portableSpeaker",
    date: "home1.testimonials.weekAgo"
  }
];

const stats = [
  { number: "50K+", label: "home1.stats.happyCustomers" },
  { number: "100K+", label: "home1.stats.productsSold" },
  { number: "24/7", label: "home1.stats.support" },
  { number: "99.9%", label: "home1.stats.satisfactionRate" }
];
          ...
          <section className="py-20 bg-white dark:bg-gray-900">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="text-center mt-12">
                ...
                >
                  {showAllProducts ? t('home1.featuredProducts.showLess') : t('home1.featuredProducts.viewAll')}
                </button>
              </div>
            </div>
          </section>
                  ...
                  <div key={index} className="group perspective-1000">
                    <div className="relative w-full h-80 transition-all duration-700 transform-style-preserve-3d group-hover:rotate-y-180">
                      ...
                      <div className="absolute inset-0 w-full h-full backface-hidden bg-white dark:bg-gray-700 rounded-xl p-6 shadow-lg border border-gray-100 dark:border-gray-600 flex flex-col items-center justify-center text-center">
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400">{t('home1.testimonials.clickToSeeMore')}</p>
                      </div>
                      ...
                      <div className="absolute inset-0 w-full h-full backface-hidden bg-indigo-600 dark:bg-indigo-700 rounded-xl p-6 shadow-lg rotate-y-180 flex flex-col items-center justify-center text-center text-white">
                        ...
                        <p className="text-sm mb-4 leading-relaxed">"{t(testimonial.content)}"</p>
                        <div className="text-xs text-indigo-200 mb-2">
                          <strong>{t('home1.testimonials.purchased')}</strong> {t(testimonial.purchase)}
                        </div>
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
                  <form onSubmit={handleSubscribe} className="space-y-6">
                    ...
                    >
                      {t('home1.newsletter.subscribe')}
                    </button>
                    
                    {isSubscribed && (
                      <div className="text-center p-3 bg-green-500/20 border border-green-400/30 rounded-lg">
                        <p className="text-green-100">{t('home1.newsletter.success')}</p>
                      </div>
                    )}
                    
                    <p className="text-xs text-indigo-200 text-center">
                      {t('home1.newsletter.privacy')}
                    </p>
                  </form>
                </div>
              </div>
