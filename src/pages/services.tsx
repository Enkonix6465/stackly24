...
export default function Services() {
  ...
  const services = [
    {
      id: 1,
      title: t('services.productListing.title'),
      slug: "product-listing",
      description: t('services.productListing.description'),
      icon: <svg xmlns="http://www.w3.org/2000/svg" width={45} height={45} viewBox="0 0 24 24"><path fill="none" stroke="currentColor" strokeLinecap="round" strokeWidth={1.5} d="m15.578 3.382l2 1.05c2.151 1.129 3.227 1.693 3.825 2.708C22 8.154 22 9.417 22 11.942v.117c0 2.524 0 3.787-.597 4.801c-.598 1.015-1.674 1.58-3.825 2.709l-2 1.049C13.822 21.539 12.944 22 12 22s-1.822-.46-3.578-1.382l-2-1.05c-2.151-1.129-3.227-1.693-3.825-2.708C2 15.846 2 14.583 2 12.06v-.117c0-2.525 0-3.788.597-4.802c.598-1.015 1.674-1.58 3.825-2.708l2-1.05C10.178 2.461 11.056 2 12 2s1.822.46 3.578 1.382ZM21 7.5l-4 2M12 12L3 7.5m9 4.5v9.5m0-9.5l4.5-2.25l.5-.25m0 0V13m0-3.5l-9.5-5"></path></svg>,
      features: [t('services.productListing.features.unlimited'), t('services.productListing.features.bulk'), t('services.productListing.features.seo'), t('services.productListing.features.multilang')],
      image: "/images/s1.jpg"
    },
    {
      id: 2,
      ...
      description: t('services.orderManagement.description'),
      ...
      features: [t('services.orderManagement.features.automation'), t('services.orderManagement.features.inventory'), t('services.orderManagement.features.shipping'), t('services.orderManagement.features.notifications')],
      image: "/images/s2.jpg"
    },
    {
      id: 3,
      title: t('services.paymentGateway.title'),
      ...
      features: [t('services.paymentGateway.features.gateways'), t('services.paymentGateway.features.fraud'), t('services.paymentGateway.features.billing'), t('services.paymentGateway.features.pci')],
      image: "/images/s3.jpg"
    },
    {
      id: 4,
      ...
      features: [t('services.customerSupport.features.chat'), t('services.customerSupport.features.ticket'), t('services.customerSupport.features.knowledge'), t('services.customerSupport.features.ai')],
      image: "/images/s4.jpg"
    },
    {
      id: 5,
      title: t('services.shippingDelivery.title'),
      slug: "shipping-delivery",
      description: t('services.shippingDelivery.description'),
      ...
      features: [t('services.shippingDelivery.features.carrier'), t('services.shippingDelivery.features.route'), t('services.shippingDelivery.features.tracking'), t('services.shippingDelivery.features.returns')],
      image: "/images/s5.jpg"
    },
    {
      id: 6,
      ...
      features: [t('services.analyticsReports.features.sales'), t('services.analyticsReports.features.insights'), t('services.analyticsReports.features.metrics'), t('services.analyticsReports.features.dashboards')],
      image: "/images/s6.jpg"
    }
  ];
  ...
  const testimonials = [
    {
      name: t('services.testimonials.david.name'),
      role: t('services.testimonials.david.role'),
      company: t('services.testimonials.david.company'),
      content: t('services.testimonials.david.content'),
      avatar: "/images/image12.jpg"
    },
    {
      name: t('services.testimonials.maria.name'),
      role: t('services.testimonials.maria.role'),
      company: t('services.testimonials.maria.company'),
      content: t('services.testimonials.maria.content'),
      avatar: "/images/image13.jpg"
    },
    {
      name: t('services.testimonials.james.name'),
      role: t('services.testimonials.james.role'),
      company: t('services.testimonials.james.company'),
      content: t('services.testimonials.james.content'),
                     ...
                     <div key={service.id} className="relative">
                       <div className="bg-white dark:bg-gray-800 rounded-xl p-6 text-center shadow-lg border border-gray-100 dark:border-gray-700 relative z-10">
                         ...
                         <div className="text-xs text-gray-500 dark:text-gray-400">
                           {t('services.howItWorks.step')} {index + 1}
                         </div>
                       </div>
                  ...
                  <div key={index} className={`relative ${index === 1 ? 'transform scale-105' : ''}`}>
                    {index === 1 && (
                      <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-indigo-600 text-white px-4 py-2 rounded-full text-sm font-semibold">
                        {t('services.pricing.professional.plan')}
                      </div>
                    )}
                    <div className={`bg-white dark:bg-gray-700 rounded-2xl p-8 shadow-lg border-2 ${index === 1 ? 'border-indigo-600' : 'border-gray-100 dark:border-gray-600'} h-full`}>
                      ...
                      <Link href="/contact" className={`w-full py-3 px-6 rounded-xl font-semibold transition-colors duration-300 text-center block ${
                        ...
                        {index === 1 ? t('services.hero.cta') : t('services.hero.learnMore')}
                      </Link>
                    </div>
                  </div>
                ))}
